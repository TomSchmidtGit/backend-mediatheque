...
# Script de configuration de la CI pour le backend médiathèque
# Usage: ./scripts/setup-ci.sh

set -e

echo "🚀 Configuration de la CI pour le backend médiathèque..."
...
# Test des tests
echo "🧪 Test des tests..."
npm run test:ci --silent || echo "⚠️  Les tests ont des erreurs"

echo ""
echo "🎉 Configuration de la CI terminée pour le backend !"
echo ""
